...
#define _STM32N6XX_ETH_DRIVER_H
...
//TX buffer size
#ifndef STM32N6XX_ETH_TX_BUFFER_SIZE
   #define STM32N6XX_ETH_TX_BUFFER_SIZE 1536
#elif (STM32N6XX_ETH_TX_BUFFER_SIZE != 1536)
   #error STM32N6XX_ETH_TX_BUFFER_SIZE parameter is not valid
#endif
...
//RX buffer size
#ifndef STM32N6XX_ETH_RX_BUFFER_SIZE
   #define STM32N6XX_ETH_RX_BUFFER_SIZE 1536
#elif (STM32N6XX_ETH_RX_BUFFER_SIZE != 1536)
   #error STM32N6XX_ETH_RX_BUFFER_SIZE parameter is not valid
#endif

//Interrupt priority grouping
#ifndef STM32N6XX_ETH_IRQ_PRIORITY_GROUPING
   #define STM32N6XX_ETH_IRQ_PRIORITY_GROUPING 3
#elif (STM32N6XX_ETH_IRQ_PRIORITY_GROUPING < 0)
   #error STM32N6XX_ETH_IRQ_PRIORITY_GROUPING parameter is not valid
#endif

//Ethernet interrupt group priority
#ifndef STM32N6XX_ETH_IRQ_GROUP_PRIORITY
   #define STM32N6XX_ETH_IRQ_GROUP_PRIORITY 12
#elif (STM32N6XX_ETH_IRQ_GROUP_PRIORITY < 0)
   #error STM32N6XX_ETH_IRQ_GROUP_PRIORITY parameter is not valid
#endif

//Ethernet interrupt subpriority
#ifndef STM32N6XX_ETH_IRQ_SUB_PRIORITY
   #define STM32N6XX_ETH_IRQ_SUB_PRIORITY 0
#elif (STM32N6XX_ETH_IRQ_SUB_PRIORITY < 0)
   #error STM32N6XX_ETH_IRQ_SUB_PRIORITY parameter is not valid
#endif

//Name of the section where to place DMA buffers
#ifndef STM32N6XX_ETH_RAM_SECTION
   #define STM32N6XX_ETH_RAM_SECTION ".ram_no_cache"
#endif
...
#define ETH_MTLTXQxOMR_TQS_Val(n)   (((n) << ETH_MTLTXQxOMR_TQS_Pos) & ETH_MTLTXQxOMR_TQS_Msk)
#define ETH_MTLTXQxOMR_TXQEN_Val(n) (((n) << ETH_MTLTXQxOMR_TXQEN_Pos) & ETH_MTLTXQxOMR_TXQEN_Msk)
#define ETH_MTLRXQxOMR_RQS_Val(n)   (((n) << ETH_MTLRXQxOMR_RQS_Pos) & ETH_MTLRXQxOMR_RQS_Msk)
...
#define ETH_DMACxCR_DSL_Val(n)      (((n) << ETH_DMACxCR_DSL_Pos) & ETH_DMACxCR_DSL_Msk)
#define ETH_DMACxTXCR_TXPBL_Val(n)  (((n) << ETH_DMACxTXCR_TXPBL_Pos) & ETH_DMACxTXCR_TXPBL_Msk)
#define ETH_DMACxRXCR_RXPBL_Val(n)  (((n) << ETH_DMACxRXCR_RXPBL_Pos) & ETH_DMACxRXCR_RXPBL_Msk)
#define ETH_DMACxRXCR_RBSZ_Val(n)   (((n) << ETH_DMACxRXCR_RBSZ_Pos) & ETH_DMACxRXCR_RBSZ_Msk)
...
extern const NicDriver stm32n6xxEthDriver;

//STM32N6 Ethernet MAC related functions
error_t stm32n6xxEthInit(NetInterface *interface);
void stm32n6xxEthInitGpio(NetInterface *interface);
