...
#ifndef _STM32C5XX_ETH_DRIVER_H
#define _STM32C5XX_ETH_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef STM32C5XX_ETH_TX_BUFFER_COUNT
   #define STM32C5XX_ETH_TX_BUFFER_COUNT 3
#elif (STM32C5XX_ETH_TX_BUFFER_COUNT < 1)
   #error STM32C5XX_ETH_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef STM32C5XX_ETH_TX_BUFFER_SIZE
   #define STM32C5XX_ETH_TX_BUFFER_SIZE 1536
#elif (STM32C5XX_ETH_TX_BUFFER_SIZE != 1536)
   #error STM32C5XX_ETH_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef STM32C5XX_ETH_RX_BUFFER_COUNT
   #define STM32C5XX_ETH_RX_BUFFER_COUNT 6
#elif (STM32C5XX_ETH_RX_BUFFER_COUNT < 1)
   #error STM32C5XX_ETH_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef STM32C5XX_ETH_RX_BUFFER_SIZE
   #define STM32C5XX_ETH_RX_BUFFER_SIZE 1536
#elif (STM32C5XX_ETH_RX_BUFFER_SIZE != 1536)
   #error STM32C5XX_ETH_RX_BUFFER_SIZE parameter is not valid
#endif

//Interrupt priority grouping
#ifndef STM32C5XX_ETH_IRQ_PRIORITY_GROUPING
   #define STM32C5XX_ETH_IRQ_PRIORITY_GROUPING 3
#elif (STM32C5XX_ETH_IRQ_PRIORITY_GROUPING < 0)
   #error STM32C5XX_ETH_IRQ_PRIORITY_GROUPING parameter is not valid
#endif

//Ethernet interrupt group priority
#ifndef STM32C5XX_ETH_IRQ_GROUP_PRIORITY
   #define STM32C5XX_ETH_IRQ_GROUP_PRIORITY 12
#elif (STM32C5XX_ETH_IRQ_GROUP_PRIORITY < 0)
   #error STM32C5XX_ETH_IRQ_GROUP_PRIORITY parameter is not valid
#endif

//Ethernet interrupt subpriority
#ifndef STM32C5XX_ETH_IRQ_SUB_PRIORITY
   #define STM32C5XX_ETH_IRQ_SUB_PRIORITY 0
#elif (STM32C5XX_ETH_IRQ_SUB_PRIORITY < 0)
   #error STM32C5XX_ETH_IRQ_SUB_PRIORITY parameter is not valid
#endif
...
#define ETH_DMACCR_DSL_Val(n)       (((n) << ETH_DMACCR_DSL_Pos) & ETH_DMACCR_DSL_Msk)
#define ETH_DMACTXCR_TXPBL_Val(n)   (((n) << ETH_DMACTXCR_TXPBL_Pos) & ETH_DMACTXCR_TXPBL_Msk)
#define ETH_DMACRXCR_RXPBL_Val(n)   (((n) << ETH_DMACRXCR_RXPBL_Pos) & ETH_DMACRXCR_RXPBL_Msk)
#define ETH_DMACRXCR_RBSZ_Val(n)    (((n) << ETH_DMACRXCR_RBSZ_Pos) & ETH_DMACRXCR_RBSZ_Msk)
...
extern const NicDriver stm32c5xxEthDriver;

//STM32C5 Ethernet MAC related functions
error_t stm32c5xxEthInit(NetInterface *interface);
void stm32c5xxEthInitGpio(NetInterface *interface);
