...
#ifndef _SC598_ETH2_DRIVER_H
#define _SC598_ETH2_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef SC598_ETH2_TX_BUFFER_COUNT
   #define SC598_ETH2_TX_BUFFER_COUNT 8
#elif (SC598_ETH2_TX_BUFFER_COUNT < 1)
   #error SC598_ETH2_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef SC598_ETH2_TX_BUFFER_SIZE
   #define SC598_ETH2_TX_BUFFER_SIZE 1536
#elif (SC598_ETH2_TX_BUFFER_SIZE != 1536)
   #error SC598_ETH2_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef SC598_ETH2_RX_BUFFER_COUNT
   #define SC598_ETH2_RX_BUFFER_COUNT 8
#elif (SC598_ETH2_RX_BUFFER_COUNT < 1)
   #error SC598_ETH2_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef SC598_ETH2_RX_BUFFER_SIZE
   #define SC598_ETH2_RX_BUFFER_SIZE 1536
#elif (SC598_ETH2_RX_BUFFER_SIZE != 1536)
   #error SC598_ETH2_RX_BUFFER_SIZE parameter is not valid
#endif

//Ethernet interrupt priority
#ifndef SC598_ETH2_IRQ_PRIORITY
   #define SC598_ETH2_IRQ_PRIORITY 0
#elif (SC598_ETH2_IRQ_PRIORITY < 0)
   #error SC598_ETH2_IRQ_PRIORITY parameter is not valid
#endif

//Name of the section where to place DMA buffers
#ifndef SC598_ETH2_RAM_SECTION
   #define SC598_ETH2_RAM_SECTION ".l2_uncached_data"
#endif
...
extern const NicDriver sc598Eth2Driver;

//ADSP-SC598 Ethernet MAC related functions
error_t sc598Eth2Init(NetInterface *interface);
void sc598Eth2InitGpio(NetInterface *interface);
void sc598Eth2ResetPhy(NetInterface *interface);
