...
#ifndef _SC589_ETH1_DRIVER_H
#define _SC589_ETH1_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef SC589_ETH1_TX_BUFFER_COUNT
   #define SC589_ETH1_TX_BUFFER_COUNT 3
#elif (SC589_ETH1_TX_BUFFER_COUNT < 1)
   #error SC589_ETH1_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef SC589_ETH1_TX_BUFFER_SIZE
   #define SC589_ETH1_TX_BUFFER_SIZE 1536
#elif (SC589_ETH1_TX_BUFFER_SIZE != 1536)
   #error SC589_ETH1_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef SC589_ETH1_RX_BUFFER_COUNT
   #define SC589_ETH1_RX_BUFFER_COUNT 6
#elif (SC589_ETH1_RX_BUFFER_COUNT < 1)
   #error SC589_ETH1_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef SC589_ETH1_RX_BUFFER_SIZE
   #define SC589_ETH1_RX_BUFFER_SIZE 1536
#elif (SC589_ETH1_RX_BUFFER_SIZE != 1536)
   #error SC589_ETH1_RX_BUFFER_SIZE parameter is not valid
#endif

//Ethernet interrupt priority
#ifndef SC589_ETH1_IRQ_PRIORITY
   #define SC589_ETH1_IRQ_PRIORITY 0
#elif (SC589_ETH1_IRQ_PRIORITY < 0)
   #error SC589_ETH1_IRQ_PRIORITY parameter is not valid
#endif

//Name of the section where to place DMA buffers
#ifndef SC589_ETH1_RAM_SECTION
   #define SC589_ETH1_RAM_SECTION ".l2_uncached_data"
#endif

//EMAC0 peripheral ID
#define EMAC0_SPU_PID 55
