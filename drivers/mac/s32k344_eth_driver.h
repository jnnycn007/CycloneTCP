...
#ifndef _S32K344_ETH_DRIVER_H
#define _S32K344_ETH_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef S32K344_ETH_TX_BUFFER_COUNT
   #define S32K344_ETH_TX_BUFFER_COUNT 3
#elif (S32K344_ETH_TX_BUFFER_COUNT < 1)
   #error S32K344_ETH_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef S32K344_ETH_TX_BUFFER_SIZE
   #define S32K344_ETH_TX_BUFFER_SIZE 1536
#elif (S32K344_ETH_TX_BUFFER_SIZE != 1536)
   #error S32K344_ETH_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef S32K344_ETH_RX_BUFFER_COUNT
   #define S32K344_ETH_RX_BUFFER_COUNT 6
#elif (S32K344_ETH_RX_BUFFER_COUNT < 1)
   #error S32K344_ETH_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef S32K344_ETH_RX_BUFFER_SIZE
   #define S32K344_ETH_RX_BUFFER_SIZE 1536
#elif (S32K344_ETH_RX_BUFFER_SIZE != 1536)
   #error S32K344_ETH_RX_BUFFER_SIZE parameter is not valid
#endif

//Interrupt priority grouping
#ifndef S32K344_ETH_IRQ_PRIORITY_GROUPING
   #define S32K344_ETH_IRQ_PRIORITY_GROUPING 3
#elif (S32K344_ETH_IRQ_PRIORITY_GROUPING < 0)
   #error S32K344_ETH_IRQ_PRIORITY_GROUPING parameter is not valid
#endif

//Ethernet interrupt group priority
#ifndef S32K344_ETH_IRQ_GROUP_PRIORITY
   #define S32K344_ETH_IRQ_GROUP_PRIORITY 12
#elif (S32K344_ETH_IRQ_GROUP_PRIORITY < 0)
   #error S32K344_ETH_IRQ_GROUP_PRIORITY parameter is not valid
#endif

//Ethernet interrupt subpriority
#ifndef S32K344_ETH_IRQ_SUB_PRIORITY
   #define S32K344_ETH_IRQ_SUB_PRIORITY 0
#elif (S32K344_ETH_IRQ_SUB_PRIORITY < 0)
   #error S32K344_ETH_IRQ_SUB_PRIORITY parameter is not valid
#endif

//Name of the section where to place DMA buffers
#ifndef S32K344_ETH_RAM_SECTION
   #define S32K344_ETH_RAM_SECTION "NonCacheable"
#endif

//Remap address for DMA engine
#ifndef S32K344_ETH_REMAP_ADDR
...
extern const NicDriver s32k344EthDriver;

//S32K344 Ethernet MAC related functions
