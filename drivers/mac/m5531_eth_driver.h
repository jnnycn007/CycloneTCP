/**
 * @file m5531_eth_driver.h
 * @brief Nuvoton M5531 Ethernet MAC driver
 *
 * @section License
 *
...
#ifndef _M5531_ETH_DRIVER_H
#define _M5531_ETH_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef M5531_ETH_TX_BUFFER_COUNT
   #define M5531_ETH_TX_BUFFER_COUNT 8
#elif (M5531_ETH_TX_BUFFER_COUNT < 1)
   #error M5531_ETH_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef M5531_ETH_TX_BUFFER_SIZE
   #define M5531_ETH_TX_BUFFER_SIZE 1536
#elif (M5531_ETH_TX_BUFFER_SIZE != 1536)
   #error M5531_ETH_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef M5531_ETH_RX_BUFFER_COUNT
   #define M5531_ETH_RX_BUFFER_COUNT 8
#elif (M5531_ETH_RX_BUFFER_COUNT < 1)
   #error M5531_ETH_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef M5531_ETH_RX_BUFFER_SIZE
   #define M5531_ETH_RX_BUFFER_SIZE 1536
#elif (M5531_ETH_RX_BUFFER_SIZE != 1536)
   #error M5531_ETH_RX_BUFFER_SIZE parameter is not valid
#endif

//Interrupt priority grouping
#ifndef M5531_ETH_IRQ_PRIORITY_GROUPING
   #define M5531_ETH_IRQ_PRIORITY_GROUPING 4
#elif (M5531_ETH_IRQ_PRIORITY_GROUPING < 0)
   #error M5531_ETH_IRQ_PRIORITY_GROUPING parameter is not valid
#endif

//Ethernet interrupt group priority
#ifndef M5531_ETH_IRQ_GROUP_PRIORITY
   #define M5531_ETH_IRQ_GROUP_PRIORITY 6
#elif (M5531_ETH_IRQ_GROUP_PRIORITY < 0)
   #error M5531_ETH_IRQ_GROUP_PRIORITY parameter is not valid
#endif

//Ethernet interrupt subpriority
#ifndef M5531_ETH_IRQ_SUB_PRIORITY
   #define M5531_ETH_IRQ_SUB_PRIORITY 0
#elif (M5531_ETH_IRQ_SUB_PRIORITY < 0)
   #error M5531_ETH_IRQ_SUB_PRIORITY parameter is not valid
#endif

//Name of the section where to place DMA buffers
#ifndef M5531_ETH_RAM_SECTION
   #define M5531_ETH_RAM_SECTION ".bss.NonCacheable.ZeroInit"
#endif

//EMAC registers
#define EMAC_MAC_CONFIG                                     *((volatile uint32_t *) (EMAC0_BASE + 0x0000))
#define EMAC_MAC_FRAME_FILTER                               *((volatile uint32_t *) (EMAC0_BASE + 0x0004))
#define EMAC_GMII_ADDR                                      *((volatile uint32_t *) (EMAC0_BASE + 0x0010))
#define EMAC_GMII_DATA                                      *((volatile uint32_t *) (EMAC0_BASE + 0x0014))
#define EMAC_FLOW_CONTROL                                   *((volatile uint32_t *) (EMAC0_BASE + 0x0018))
#define EMAC_VLAN_TAG                                       *((volatile uint32_t *) (EMAC0_BASE + 0x001C))
#define EMAC_VERSION                                        *((volatile uint32_t *) (EMAC0_BASE + 0x0020))
#define EMAC_DEBUG                                          *((volatile uint32_t *) (EMAC0_BASE + 0x0024))
#define EMAC_PMT_CONTROL_STATUS                             *((volatile uint32_t *) (EMAC0_BASE + 0x002C))
#define EMAC_INTERRUPT_STATUS                               *((volatile uint32_t *) (EMAC0_BASE + 0x0038))
#define EMAC_INTERRUPT_MASK                                 *((volatile uint32_t *) (EMAC0_BASE + 0x003C))
#define EMAC_MAC_ADDR0_HIGH                                 *((volatile uint32_t *) (EMAC0_BASE + 0x0040))
#define EMAC_MAC_ADDR0_LOW                                  *((volatile uint32_t *) (EMAC0_BASE + 0x0044))
#define EMAC_MAC_ADDR1_HIGH                                 *((volatile uint32_t *) (EMAC0_BASE + 0x0048))
#define EMAC_MAC_ADDR1_LOW                                  *((volatile uint32_t *) (EMAC0_BASE + 0x004C))
#define EMAC_MAC_ADDR2_HIGH                                 *((volatile uint32_t *) (EMAC0_BASE + 0x0050))
#define EMAC_MAC_ADDR2_LOW                                  *((volatile uint32_t *) (EMAC0_BASE + 0x0054))
#define EMAC_MAC_ADDR3_HIGH                                 *((volatile uint32_t *) (EMAC0_BASE + 0x0058))
#define EMAC_MAC_ADDR3_LOW                                  *((volatile uint32_t *) (EMAC0_BASE + 0x005C))
#define EMAC_MAC_ADDR4_HIGH                                 *((volatile uint32_t *) (EMAC0_BASE + 0x0060))
#define EMAC_MAC_ADDR4_LOW                                  *((volatile uint32_t *) (EMAC0_BASE + 0x0064))
#define EMAC_MAC_ADDR5_HIGH                                 *((volatile uint32_t *) (EMAC0_BASE + 0x0068))
#define EMAC_MAC_ADDR5_LOW                                  *((volatile uint32_t *) (EMAC0_BASE + 0x006C))
#define EMAC_MAC_ADDR6_HIGH                                 *((volatile uint32_t *) (EMAC0_BASE + 0x0070))
#define EMAC_MAC_ADDR6_LOW                                  *((volatile uint32_t *) (EMAC0_BASE + 0x0074))
#define EMAC_MAC_ADDR7_HIGH                                 *((volatile uint32_t *) (EMAC0_BASE + 0x0078))
#define EMAC_MAC_ADDR7_LOW                                  *((volatile uint32_t *) (EMAC0_BASE + 0x007C))
#define EMAC_MAC_ADDR8_HIGH                                 *((volatile uint32_t *) (EMAC0_BASE + 0x0080))
#define EMAC_MAC_ADDR8_LOW                                  *((volatile uint32_t *) (EMAC0_BASE + 0x0084))
#define EMAC_WDOG_TIMEOUT                                   *((volatile uint32_t *) (EMAC0_BASE + 0x00DC))
#define EMAC_VLAN_INCL_REG                                  *((volatile uint32_t *) (EMAC0_BASE + 0x0584))
#define EMAC_TIMESTAMP_CONTROL                              *((volatile uint32_t *) (EMAC0_BASE + 0x0700))
#define EMAC_SUB_SECOND_INCREMENT                           *((volatile uint32_t *) (EMAC0_BASE + 0x0704))
#define EMAC_SYSTEM_TIME_SECONDS                            *((volatile uint32_t *) (EMAC0_BASE + 0x0708))
#define EMAC_SYSTEM_TIME_NANOSECONDS                        *((volatile uint32_t *) (EMAC0_BASE + 0x070C))
#define EMAC_SYSTEM_TIME_SECONDS_UPDATE                     *((volatile uint32_t *) (EMAC0_BASE + 0x0710))
#define EMAC_SYSTEM_TIME_NANOSECONDS_UPDATE                 *((volatile uint32_t *) (EMAC0_BASE + 0x0714))
#define EMAC_TIMESTAMP_ADDEND                               *((volatile uint32_t *) (EMAC0_BASE + 0x0718))
#define EMAC_TARGET_TIME_SECONDS                            *((volatile uint32_t *) (EMAC0_BASE + 0x071C))
#define EMAC_TARGET_TIME_NANOSECONDS                        *((volatile uint32_t *) (EMAC0_BASE + 0x0720))
#define EMAC_SYSTEM_TIME_HIGHER_WORD_SECONDS                *((volatile uint32_t *) (EMAC0_BASE + 0x0724))
#define EMAC_TIMESTAMP_STATUS                               *((volatile uint32_t *) (EMAC0_BASE + 0x0728))
#define EMAC_PPS_CONTROL                                    *((volatile uint32_t *) (EMAC0_BASE + 0x072C))
#define EMAC_PPS0_INTERVAL                                  *((volatile uint32_t *) (EMAC0_BASE + 0x0760))
#define EMAC_PPS0_WIDTH                                     *((volatile uint32_t *) (EMAC0_BASE + 0x0764))
#define EMAC_BUS_MODE                                       *((volatile uint32_t *) (EMAC0_BASE + 0x1000))
#define EMAC_TRANSMIT_POLL_DEMAND                           *((volatile uint32_t *) (EMAC0_BASE + 0x1004))
#define EMAC_RECEIVE_POLL_DEMAND                            *((volatile uint32_t *) (EMAC0_BASE + 0x1008))
#define EMAC_RECEIVE_DESCRIPTOR_LIST_ADDR                   *((volatile uint32_t *) (EMAC0_BASE + 0x100C))
#define EMAC_TRANSMIT_DESCRIPTOR_LIST_ADDR                  *((volatile uint32_t *) (EMAC0_BASE + 0x1010))
#define EMAC_STATUS                                         *((volatile uint32_t *) (EMAC0_BASE + 0x1014))
#define EMAC_OPERATION_MODE                                 *((volatile uint32_t *) (EMAC0_BASE + 0x1018))
#define EMAC_INTERRUPT_ENABLE                               *((volatile uint32_t *) (EMAC0_BASE + 0x101C))
#define EMAC_MISSED_FRAME_AND_BUFFER_OVERFLOW_CNT           *((volatile uint32_t *) (EMAC0_BASE + 0x1020))
#define EMAC_RECEIVE_INTERRUPT_WATCHDOG_TIMER               *((volatile uint32_t *) (EMAC0_BASE + 0x1024))
#define EMAC_AHB_STATUS                                     *((volatile uint32_t *) (EMAC0_BASE + 0x102C))
#define EMAC_CURRENT_HOST_TRANSMIT_DESCRIPTOR               *((volatile uint32_t *) (EMAC0_BASE + 0x1048))
#define EMAC_CURRENT_HOST_RECEIVE_DESCRIPTOR                *((volatile uint32_t *) (EMAC0_BASE + 0x104C))
#define EMAC_CURRENT_HOST_TRANSMIT_BUFFER_ADDR              *((volatile uint32_t *) (EMAC0_BASE + 0x1050))
#define EMAC_CURRENT_HOST_RECEIVE_BUFFER_ADDR               *((volatile uint32_t *) (EMAC0_BASE + 0x1054))
#define EMAC_HW_FEATURE                                     *((volatile uint32_t *) (EMAC0_BASE + 0x1058))
...
extern const NicDriver m5531EthDriver;

//M5531 Ethernet MAC related functions
...
error_t m5531EthSendPacket(NetInterface *interface,
...
void m5531EthWritePhyReg(uint8_t opcode, uint8_t phyAddr,
   uint8_t regAddr, uint16_t data);

uint16_t m5531EthReadPhyReg(uint8_t opcode, uint8_t phyAddr,
   uint8_t regAddr);
