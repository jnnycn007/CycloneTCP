...
#ifndef _SC589_ETH2_DRIVER_H
#define _SC589_ETH2_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef SC589_ETH2_TX_BUFFER_COUNT
   #define SC589_ETH2_TX_BUFFER_COUNT 3
#elif (SC589_ETH2_TX_BUFFER_COUNT < 1)
   #error SC589_ETH2_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef SC589_ETH2_TX_BUFFER_SIZE
   #define SC589_ETH2_TX_BUFFER_SIZE 1536
#elif (SC589_ETH2_TX_BUFFER_SIZE != 1536)
   #error SC589_ETH2_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef SC589_ETH2_RX_BUFFER_COUNT
   #define SC589_ETH2_RX_BUFFER_COUNT 6
#elif (SC589_ETH2_RX_BUFFER_COUNT < 1)
   #error SC589_ETH2_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef SC589_ETH2_RX_BUFFER_SIZE
   #define SC589_ETH2_RX_BUFFER_SIZE 1536
#elif (SC589_ETH2_RX_BUFFER_SIZE != 1536)
   #error SC589_ETH2_RX_BUFFER_SIZE parameter is not valid
#endif

//Ethernet interrupt priority
#ifndef SC589_ETH2_IRQ_PRIORITY
   #define SC589_ETH2_IRQ_PRIORITY 0
#elif (SC589_ETH2_IRQ_PRIORITY < 0)
   #error SC589_ETH2_IRQ_PRIORITY parameter is not valid
#endif

//Name of the section where to place DMA buffers
#ifndef SC589_ETH2_RAM_SECTION
   #define SC589_ETH2_RAM_SECTION ".l2_uncached_data"
#endif

//EMAC1 peripheral ID
#define EMAC1_SPU_PID 56
...
extern const NicDriver sc589Eth2Driver;

//ADSP-SC589 Ethernet MAC related functions
error_t sc589Eth2Init(NetInterface *interface);
void sc589Eth2InitGpio(NetInterface *interface);
