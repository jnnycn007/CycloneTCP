...
#ifndef _SC835_ETH_DRIVER_H
#define _SC835_ETH_DRIVER_H

//Dependencies
#include "core/nic.h"

//Number of TX buffers
#ifndef SC835_ETH_TX_BUFFER_COUNT
   #define SC835_ETH_TX_BUFFER_COUNT 8
#elif (SC835_ETH_TX_BUFFER_COUNT < 1)
   #error SC835_ETH_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef SC835_ETH_TX_BUFFER_SIZE
   #define SC835_ETH_TX_BUFFER_SIZE 1536
#elif (SC835_ETH_TX_BUFFER_SIZE != 1536)
   #error SC835_ETH_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef SC835_ETH_RX_BUFFER_COUNT
   #define SC835_ETH_RX_BUFFER_COUNT 8
#elif (SC835_ETH_RX_BUFFER_COUNT < 1)
   #error SC835_ETH_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef SC835_ETH_RX_BUFFER_SIZE
   #define SC835_ETH_RX_BUFFER_SIZE 1536
#elif (SC835_ETH_RX_BUFFER_SIZE != 1536)
   #error SC835_ETH_RX_BUFFER_SIZE parameter is not valid
#endif

//Ethernet interrupt priority
#ifndef SC835_ETH_IRQ_PRIORITY
   #define SC835_ETH_IRQ_PRIORITY 0
#elif (SC835_ETH_IRQ_PRIORITY < 0)
   #error SC835_ETH_IRQ_PRIORITY parameter is not valid
#endif

//Name of the section where to place DMA buffers
#ifndef SC835_ETH_RAM_SECTION
   #define SC835_ETH_RAM_SECTION ".L1.data"
#endif

//EMAC0 peripheral ID
#define EMAC0_SPU_PID 97
...
extern const NicDriver sc835EthDriver;

//ADSP-SC835 Ethernet MAC related functions
error_t sc835EthInit(NetInterface *interface);
void sc835EthInitGpio(NetInterface *interface);
void sc835EthResetPhy(NetInterface *interface);
