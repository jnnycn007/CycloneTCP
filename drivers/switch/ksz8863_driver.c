...
error_t ksz8863Init(NetInterface *interface)
{
   ...
   if(interface->spiDriver == NULL)
   {
      ...
      do
      {
         //Read PHYID1 register
         id = ksz8863ReadPhyReg(interface, KSZ8863_PORT1, KSZ8863_PHYID1);

         //Check the identifier against the expected value
      } while(id != KSZ8863_PHYID1_DEFAULT);
